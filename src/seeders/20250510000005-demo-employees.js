...
module.exports = {
  async up (queryInterface, Sequelize) {
    ...
    const rohithPassword = await bcrypt.hash('password123', 10);
    ...
    await queryInterface.bulkInsert('employees', [
      {
        ...
        first_name: 'Rohith',
        last_name: 'Kumar',
        email: 'rohith@qore.com',
        phone: '+91-9876543210',
        password: rohithPassword,
        gender: 'male',
        dob: '1990-01-01',
        branch_id: 1,
        department_id: null,
      ...
      },
      {
        ...
        branch_id: 1,
        department_id: null,
        designation_id: 2, // Changed to CTO from CEO
        position: 'Admin',
        employment_status: 'full-time',
